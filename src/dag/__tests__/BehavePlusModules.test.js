...
test('4: deactivateAll(), then indivudally activate()', () => {
  ...
  expect(dag.enabledNodes()).toHaveLength(136) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.enabledNodes()).toHaveLength(141) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.get('module.treeMortality').value()).toEqual('active')
  expect(dag.get('link.treeMortality').value()).toEqual('linkedToScorchHeight')
  expect(dag.enabledNodes(dag)).toHaveLength(148) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.get('module.treeMortality').value()).toEqual('active')
  expect(dag.get('link.treeMortality').value()).toEqual('linkedToScorchHeight')
  expect(dag.enabledNodes(dag)).toHaveLength(834) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.get('module.treeMortality').value()).toEqual('active')
  expect(dag.get('link.treeMortality').value()).toEqual('linkedToScorchHeight')
  expect(dag.enabledNodes(dag)).toHaveLength(1154) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.get('module.treeMortality').value()).toEqual('active')
  expect(dag.get('link.treeMortality').value()).toEqual('linkedToScorchHeight')
  expect(dag.enabledNodes(dag)).toHaveLength(1162) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.get('module.treeMortality').value()).toEqual('active')
  expect(dag.get('link.treeMortality').value()).toEqual('linkedToScorchHeight')
  expect(dag.enabledNodes(dag)).toHaveLength(1181) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.get('module.treeMortality').value()).toEqual('active')
  expect(dag.get('link.treeMortality').value()).toEqual('linkedToScorchHeight')
  expect(dag.enabledNodes(dag)).toHaveLength(1248) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.get('module.treeMortality').value()).toEqual('active')
  expect(dag.get('link.treeMortality').value()).toEqual('linkedToScorchHeight')
  expect(dag.enabledNodes(dag)).toHaveLength(1253) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.enabledNodes(dag)).toHaveLength(1229) // NOTE: this will change when the genome changes!!
  ...
  mod.deactivate('module.surfaceFire')
  expect(dag.enabledNodes(dag)).toHaveLength(543) // NOTE: this will change when the genome changes!!
  ...
  expect(dag.enabledNodes(dag)).toHaveLength(475) // NOTE: this will change when the genome changes!!
  expect(dag.get('link.crownFire').value()).toEqual('standAlone')
  expect(dag.get('link.crownSpot').value()).toEqual('linkedToCrownFire')
  expect(dag.get('link.fireContain').value()).toEqual('standAlone')
  expect(dag.get('link.fireEllipse').value()).toEqual('standAlone')
  ...
  mod.deactivate(['module.crownFire'])
  expect(dag.enabledNodes(dag)).toHaveLength(155) // NOTE: this will change when the genome changes!!
  expect(dag.get('link.crownFire').value()).toEqual('standAlone')
  ...
  expect(dag.enabledNodes(dag)).toHaveLength(140) // NOTE: this will change when the genome changes!!

  // De-activating tree mortality disables 4 Nodes and no links
  mod.deactivate('module.treeMortality')
  expect(dag.enabledNodes(dag)).toHaveLength(136) // NOTE: this will change when the genome changes!!
})
...
test('5: Module selection', () => {
  ...
  mod.activate('module.surfaceSpot')
  expect(dag.enabledNodes(dag)).toHaveLength(143) // NOTE: this will change when the genome changes!!
