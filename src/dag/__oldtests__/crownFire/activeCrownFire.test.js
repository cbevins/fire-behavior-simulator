...
import { CrownFire } from '@cbevins/fire-behavior-models'
...
test('1: Active crown fire per BP6', () => {
  ...
  requiredInputs = dag.requiredInputNodes()
  expect(requiredInputs.length).toEqual(Inputs1.length + Inputs2.length + Inputs3.length)
...
test('2: Crown fire equations coverage', () => {
  ...
  expect(CrownFire.rSa(oActive, surfRos0, surfWaf, surfWindB, surfWindK, surfPhiS))
    .toEqual(10200)
  ...
  expect(CrownFire.transitionRatio(1, 1)).toEqual(1)
  expect(CrownFire.transitionRatio(0, 1)).toEqual(0)
  expect(CrownFire.transitionRatio(1, 0)).toEqual(0)
  expect(CrownFire.transitionRatio(0, 0)).toEqual(0)

  expect(CrownFire.type(0, 0)).toEqual(CrownFire.SURFACE)
  expect(CrownFire.type(0, 1)).toEqual(CrownFire.CONDITIONAL)
  expect(CrownFire.type(1, 0)).toEqual(CrownFire.PASSIVE)
  expect(CrownFire.type(1, 1)).toEqual(CrownFire.ACTIVE)
})
