 ...
 *
 * Variant_Quantity_Slate defines the units-of-measure applied to Quantity Variants
 ...
 */
const Variant_Quantity_Slate = new Map([
...
function applyQuantity(vmap, slateKey) {
  Variant_Quantity_Slate.forEach((spec, key) => {
    // if (!vmap.has(key)) throw new Error(`VariantMap has no key '${key}'`)
